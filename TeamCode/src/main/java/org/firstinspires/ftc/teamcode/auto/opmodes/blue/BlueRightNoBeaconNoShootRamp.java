 ...
 */
@Autonomous(name="[Blue-Right] NoBeacon NoShoot Ramp",group="H")
public class BlueRightNoBeaconNoShootRamp extends AdvOpMode {
    public BlueRightNoBeaconNoShootRamp() {
