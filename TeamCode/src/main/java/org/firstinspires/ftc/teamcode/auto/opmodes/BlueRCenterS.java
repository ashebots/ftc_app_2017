...
@Autonomous(name="[Blue R] Center (S)", group ="B")
public class BlueRCenterS extends AdvOpMode {
    AutoRoutine a;
    @Override
    public void init() {
        ...
        a = new ModularAuto(route, true, c, s, mtr("Accelerator"), mtr("Sweeper"), mtr("topSweep"),2000);
    }
