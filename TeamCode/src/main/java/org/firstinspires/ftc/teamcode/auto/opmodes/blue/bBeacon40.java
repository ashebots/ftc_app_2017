 ...
 */
@Autonomous(name="BlueR 1B C [40*]", group="K")
public class bBeacon40 extends AdvOpMode {
    public bBeacon40() {
    ...
    public void init() {
        ...
        a = new ModularAuto(sequence, true, c,s,mtr("Accelerator"),mtr("Sweeper"),mtr("topSweep"), 0);
