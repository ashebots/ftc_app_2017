 ...
 */
@Autonomous(name="[Red-Left] NoBeacon NoShoot Center",group="F")
public class RedLeftNoBeaconNoShootCenter extends AdvOpMode {
    public RedLeftNoBeaconNoShootCenter() {
